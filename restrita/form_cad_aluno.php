                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="select" id="select" class="form-control">
                                    ...
                                    <option value="1E">3F</option>
                                    <option value="2E">3F</option>
                                    <option value="3E">3F</option>
                                    <option value="1D">3F</option>
                                    <option value="1D">3F</option>
                                    <option value="2D">3F</option>
                                    <option value="3D">3F</option>
                                </select>
                            </div>
                        </div>
                        <div class="row form-group">
