...
<form action="atualiza_aluno.php?ra=<?php echo $ra; ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="telefone" 
                                
                                value="<?php echo $linha['tel']; ?>"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="celular" 
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="date" id="text-input" name="nascimento" 
                                
                                value="<?php echo $linha['dataNascimento']; ?>"
